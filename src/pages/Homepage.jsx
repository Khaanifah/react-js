export default function Home() {
  return (
    ...
    >
      ...
      {/* Hero content */}
      <div className="relative z-10 flex min-h-[200vh] items-start px-8 pt-40 md:px-70 md:pt-50">
        <div className="max-w-xl">
          <p
            className="mb-1 text-lg font-light text-white/90"
          ...
          <h1 className="-mt-2 flex flex-nowrap items-end">
            <span
              className="text-[300px] leading-none text-white"
              style={{ fontFamily: "'Pinyon Script', cursive", marginRight: "-0.5rem", marginBottom: "-5rem" }}
            >
              P
            </span>
            <span
              className="pb-3 flex flex-nowrap text-[70px] font-regular tracking-tight text-white md:text-[64px]"
              style={{ fontFamily: "'Sora', sans-serif", marginBottom: "-0.5rem" }}
            >
              roject
            </span>
          </h1>
          ...
          <p
            className="mt-2 flex flex-nowrap text-base font-light text-white/85"
            style={{ fontFamily: "'Sora', sans-serif", marginLeft: "10rem" }}
          >
